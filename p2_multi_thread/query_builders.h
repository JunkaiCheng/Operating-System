...
ComplexQueryBuilderClass(MinTable);
ComplexQueryBuilderClass(MaxTable);
ComplexQueryBuilderClass(SumTable);
ComplexQueryBuilderClass(AddTable);
ComplexQueryBuilderClass(SubTable);
