...
Query::Ptr DUPLICATEQueryBuilder::tryExtractQuery(TokenizedQueryString &query) {
    if (query.token.front() != "DUPLICATE")
        return this->nextBuilder->tryExtractQuery(query);
    this->parseToken(query); // Expects throw on failure.
    return std::make_unique<DuplicateQuery> ( this->targetTable, this->operandToken, this->conditionToken);
}


Query::Ptr SWAPQueryBuilder:: tryExtractQuery(TokenizedQueryString &query) {
...
Query::Ptr COUNTQueryBuilder:: tryExtractQuery(TokenizedQueryString &query) {
...
Query::Ptr MinTableQueryBuilder::tryExtractQuery(TokenizedQueryString &query) {
...
Query::Ptr MaxTableQueryBuilder::tryExtractQuery(TokenizedQueryString &query) {
...
Query::Ptr SumTableQueryBuilder::tryExtractQuery(TokenizedQueryString &query) {
...
Query::Ptr AddTableQueryBuilder::tryExtractQuery(TokenizedQueryString &query) {
...
Query::Ptr SubTableQueryBuilder::tryExtractQuery(TokenizedQueryString &query) {
